...
class TrainStepFlow(FlowSpec):
    ...
    def load_data(self):
        ...
        query = f'SELECT * FROM {os.environ["SF_TABLE"]};'  # Make sure the data comes in  INTENT, UTT, PARTITION format
    ...
    @pip(libraries={"transformers": "4.28.1", "datasets":"2.12.0"}) 
    @step
    ...
    def train_model(self):
        ...
        model = AutoModelForSequenceClassification.from_pretrained("joaobarroca/distilbert-base-uncased-finetuned-massive-intent-detection-english", 
    ...
    def deploy(self):
        ...
        predictor = huggingface_model.deploy(
            ...
            endpoint_name="banking77-local")
            
        data = {
        "inputs": "My credit card isn't working"
        }
